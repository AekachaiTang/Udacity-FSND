...
**_https://fsnd-aekachai.herokuapp.com/_**
...
```bash
$ curl -X GET https://fsnd-aekachai.herokuapp.com/actors?page1
```
...
```bash
$ curl -X GET curl -X GET https://fsnd-aekachai.herokuapp.com/actors?page1111
```
...
```bash
$ curl -X POST curl -X GET https://fsnd-aekachai.herokuapp.com/actors
```
...
```bash
$ curl -X PATCH curl -X GET https://fsnd-aekachai.herokuapp.com/actors/1
```
...
```bash
$ curl -X PATCH curl -X GET https://fsnd-aekachai.herokuapp.com/actors/111
```
...
```bash
$ curl -X DELETE curl -X GET https://fsnd-aekachai.herokuapp.com/actors/1
```
...
```bash
$ curl -X DELETE curl -X GET https://fsnd-aekachai.herokuapp.com/actors/111
```
...
```bash
$ curl -X GET curl -X GET https://fsnd-aekachai.herokuapp.com/actors?page1
```
- Fetches a list of dictionaries of examples in which the keys are the ids with all available fields
- Request Arguments: 
...
```bash
$ curl -X GET curl -X GET https://fsnd-aekachai.herokuapp.com/movies?page111
```
...
```bash
$ curl -X POST https://fsnd-aekachai.herokuapp.com/movies
```
...
```bash
$ curl -X GET https://fsnd-aekachai.herokuapp.com/?page111
```
...
```bash
$ curl -X PATCH https://fsnd-aekachai.herokuapp.com/movies/1
```
...
```bash
$ curl -X PATCH https://fsnd-aekachai.herokuapp.com/movies/111
```
...
```bash
$ curl -X DELETE https://fsnd-aekachai.herokuapp.com/movies/1
```
...
```bash
$ curl -X DELETE https://fsnd-aekachai.herokuapp.com/111
```
...
5. Go to Settings and find `domain`. Copy & paste it into config.py => auth0_config['AUTH0_DOMAIN'] (i.e. replace `"dev-k308pnp6.auth0.com"`)
6. Click on API Tab 
7. Create a new API:
   1. Name: `Music`
   2. Identifier `fsnd-aekachai`
   3. Keep Algorithm as it is
8. Go to Settings and find `Identifier`. Copy & paste it into config.py => auth0_config['API_AUDIENCE'] (i.e. replace `"fsnd-aekachai"`)
